...
INSERT INTO airlines (
  ...
  most_junior_base, most_junior_captain_hire_date, application_url
) VALUES (
...
-- Update existing airlines to ensure proper categorization if needed
UPDATE airlines SET category = 'Cargo' WHERE name IN ('FedEx Express', 'UPS Airlines', 'Atlas Air', 'Kalitta Air', 'Southern Air', 'ABX Air', 'Polar Air Cargo', 'Western Global Airlines', 'Amerijet International');