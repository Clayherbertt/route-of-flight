...
const transformDatabaseAirline = (dbAirline: DatabaseAirline): AirlineData => ({
  ...
  application_url: dbAirline.application_url || '',
  ...
  most_junior_base: dbAirline.most_junior_base || '',
  most_junior_captain_hire_date: dbAirline.most_junior_captain_hire_date || '',
  retirements_in_2025: dbAirline.retirements_in_2025 || 0,
  fo_pay_year_1: dbAirline.fo_pay_year_1 || '',
  fo_pay_year_2: dbAirline.fo_pay_year_2 || '',
  fo_pay_year_3: dbAirline.fo_pay_year_3 || '',
  fo_pay_year_4: dbAirline.fo_pay_year_4 || '',
  fo_pay_year_5: dbAirline.fo_pay_year_5 || '',
  fo_pay_year_6: dbAirline.fo_pay_year_6 || '',
  fo_pay_year_7: dbAirline.fo_pay_year_7 || '',
  fo_pay_year_8: dbAirline.fo_pay_year_8 || '',
  fo_pay_year_9: dbAirline.fo_pay_year_9 || '',
  fo_pay_year_10: dbAirline.fo_pay_year_10 || '',
  captain_pay_year_1: dbAirline.captain_pay_year_1 || '',
  captain_pay_year_2: dbAirline.captain_pay_year_2 || '',
  captain_pay_year_3: dbAirline.captain_pay_year_3 || '',
  captain_pay_year_4: dbAirline.captain_pay_year_4 || '',
  captain_pay_year_5: dbAirline.captain_pay_year_5 || '',
  captain_pay_year_6: dbAirline.captain_pay_year_6 || '',
  captain_pay_year_7: dbAirline.captain_pay_year_7 || '',
